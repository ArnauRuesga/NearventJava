...
import com.example.nearventjava.core.discover.DiscoverContract;
import com.example.nearventjava.core.discover.DiscoverPresenter;
import com.example.nearventjava.databinding.FragmentDiscoverBinding;
import com.example.nearventjava.model.Plant;
import com.example.nearventjava.view.adapter.DiscoverAdapter;
...
public class DiscoverFragment extends BaseFragment implements DiscoverContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new com.example.nearventjava.core.discover.DiscoverPresenter(this);
