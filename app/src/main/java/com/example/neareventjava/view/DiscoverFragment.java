...
import com.example.neareventjava.core.discover.DiscoverContract;
import com.example.neareventjava.core.discover.DiscoverPresenter;
import com.example.neareventjava.databinding.FragmentDiscoverBinding;
import com.example.neareventjava.model.Plant;
import com.example.neareventjava.view.adapter.DiscoverAdapter;
...
public class DiscoverFragment extends BaseFragment implements DiscoverContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new com.example.neareventjava.core.discover.DiscoverPresenter(this);
